...
while True:
	...
	# [[pg.draw.rect(sc, pg.Color('darkgray'), get_rect(x,y),border_radius=TILE // 5)
	# 	for x, col in enumerate(row) if col == 'e' ] for y, row in enumerate(grid)]
	...
	#print(grid)
	if mouse_pos and grid[mouse_pos[1]][mouse_pos[0]] != '1':
